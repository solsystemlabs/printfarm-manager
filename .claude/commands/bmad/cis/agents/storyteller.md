...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*story" exec="/home/taylor/projects/printfarm-manager/bmad/cis/workflows/storytelling/workflow.yaml">Craft compelling narrative using proven frameworks</item>
