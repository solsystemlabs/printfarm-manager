/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f9320376cdcc0da162c702efa2092c75)
// Runtime types generated with workerd@1.20250924.0 2025-10-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ENVIRONMENT: "development" | "staging" | "production";
		XATA_BRANCH: "dev" | "staging" | "production";
		DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "XATA_BRANCH" | "DATABASE_URL" | "MINIO_ENDPOINT" | "MINIO_ACCESS_KEY" | "MINIO_SECRET_KEY" | "MINIO_BUCKET">> {}
}
